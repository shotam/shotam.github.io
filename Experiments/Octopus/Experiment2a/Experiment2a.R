...
df <- subset(df, df$experiment == "Exp2")
...
pdf('/Users/shotamomma/Documents/GitHub/shotam.github.io/Experiments/Octopus/Experiment2a/Vdifference.pdf')
...
pdf('/Users/shotamomma/Documents/GitHub/shotam.github.io/Experiments/Octopus/Experiment2a/Ndifference.pdf')
ggplot(Graph, aes(x= region, y=mean, group=VerbType, color=VerbType)) +
  geom_line() +
  geom_point()+
  geom_errorbar(aes(ymin=mean-se, ymax=mean+se), width=.2,
...
pdf('/Users/shotamomma/Documents/GitHub/shotam.github.io/Experiments/Octopus/Experiment2a/VOnset.pdf')
apa_lineplot(
  data = dfV_graph,
  id = "participant",
  dv = "OnsetThe",
...
pdf('/Users/shotamomma/Documents/GitHub/shotam.github.io/Experiments/Octopus/Experiment2a/VAI.pdf')
apa_lineplot(
  dfV_graph,
  id = "participant",
  dv = "AI",
...
pdf('/Users/shotamomma/Documents/GitHub/shotam.github.io/Experiments/Octopus/Experiment2a/NOnset.pdf')
apa_lineplot(
  dfN_graph,
  id = "participant",
  dv = "OnsetThe",
...
pdf('/Users/shotamomma/Documents/GitHub/shotam.github.io/Experiments/Octopus/Experiment2a/NAT.pdf')
apa_lineplot(
  dfN_graph,
  id = "participant",
  dv = "AT",
...
V_OnsetThe_raw <- lmer(exp(ProductionTime) ~ Relatedness*VerbType + (1 + Relatedness*VerbType|participant) + (1+Relatedness|Verb), data = dfV_OnsetThe, control=lmerControl(optCtrl=list(maxfun=100000)))
...
saveRDS(V_OnsetThe_log, file = "/Users/shotamomma/Documents/GitHub/shotam.github.io/Experiments/Octopus/Experiment2a/rmodels/V_OnsetThe_log.rds")
saveRDS(V_OnsetThe_raw, file = "/Users/shotamomma/Documents/GitHub/shotam.github.io/Experiments/Octopus/Experiment2a/rmodels/V_OnsetThe_raw.rds")
saveRDS(V_OnsetThe_inverse, file = "/Users/shotamomma/Documents/GitHub/shotam.github.io/Experiments/Octopus/Experiment2a/rmodels/V_OnsetThe_inverse.rds")
V_OnsetThe_log <- readRDS(file = "/Users/shotamomma/Documents/GitHub/shotam.github.io/Experiments/Octopus/Experiment2a/rmodels/V_OnsetThe_log.rds")
V_OnsetThe_raw <- readRDS(file = "/Users/shotamomma/Documents/GitHub/shotam.github.io/Experiments/Octopus/Experiment2a/rmodels/V_OnsetThe_raw.rds")
V_OnsetThe_inverse <- readRDS(file = "/Users/shotamomma/Documents/GitHub/shotam.github.io/Experiments/Octopus/Experiment2a/rmodels/V_OnsetThe_inverse.rds")
...
saveRDS(V_unacc_log, file = "/Users/shotamomma/Documents/GitHub/shotam.github.io/Experiments/Octopus/Experiment2a/rmodels/V_unacc_log.rds")
saveRDS(V_unacc_raw, file = "/Users/shotamomma/Documents/GitHub/shotam.github.io/Experiments/Octopus/Experiment2a/rmodels/V_unacc_raw.rds")
saveRDS(V_unacc_inverse, file = "/Users/shotamomma/Documents/GitHub/shotam.github.io/Experiments/Octopus/Experiment2a/rmodels/V_unacc_inverse.rds")
...
V_AI_inverse <- glmer(AIRaw ~ Relatedness*VerbType + (1+Relatedness*VerbType|participant) + (1|Verb), data = subset(df, df$DistractorType == "Verb"), family = inverse.gaussian(link = "identity"), control=glmerControl(optCtrl=list(maxfun=100000), optimizer = 'bobyqa')) #### including by-subject random slope of Relatedness caused convergence failure

saveRDS(V_AI_log, file = "/Users/shotamomma/Documents/GitHub/shotam.github.io/Experiments/Octopus/Experiment2a/rmodels/V_AI_log.rds")
saveRDS(V_AI_raw, file = "/Users/shotamomma/Documents/GitHub/shotam.github.io/Experiments/Octopus/Experiment2a/rmodels/V_AI_raw.rds")
saveRDS(V_AI_inverse, file = "/Users/shotamomma/Documents/GitHub/shotam.github.io/Experiments/Octopus/Experiment2a/rmodels/V_AI_inverse.rds")
V_AI_log <- readRDS(file = "/Users/shotamomma/Documents/GitHub/shotam.github.io/Experiments/Octopus/Experiment2a/rmodels/V_AI_log.rds")
V_AI_raw <- readRDS(file = "/Users/shotamomma/Documents/GitHub/shotam.github.io/Experiments/Octopus/Experiment2a/rmodels/V_AI_raw.rds")
V_AI_inverse <- readRDS(file = "/Users/shotamomma/Documents/GitHub/shotam.github.io/Experiments/Octopus/Experiment2a/rmodels/V_AI_inverse.rds")
...
N_OnsetThe_inverse <- glmer(OnsetTheRaw ~ Relatedness*VerbType + (1 + Relatedness*VerbType - Relatedness - VerbType|participant) + (1+Relatedness|Verb), data = subset(df, df$DistractorType == "Noun"), family = inverse.gaussian(link = "identity"), control=glmerControl(optCtrl=list(maxfun=100000), optimizer = 'bobyqa'))

saveRDS(N_OnsetThe_log, file = "/Users/shotamomma/Documents/GitHub/shotam.github.io/Experiments/Octopus/Experiment2a/rmodels/N_OnsetThe_log.rds")
saveRDS(N_OnsetThe_raw, file = "/Users/shotamomma/Documents/GitHub/shotam.github.io/Experiments/Octopus/Experiment2a/rmodels/N_OnsetThe_raw.rds")
saveRDS(N_OnsetThe_inverse, file = "/Users/shotamomma/Documents/GitHub/shotam.github.io/Experiments/Octopus/Experiment2a/rmodels/N_OnsetThe_inverse.rds")

N_OnsetThe_log <- readRDS(file = "/Users/shotamomma/Documents/GitHub/shotam.github.io/Experiments/Octopus/Experiment2a/rmodels/N_OnsetThe_log.rds")
N_OnsetThe_raw <- readRDS(file = "/Users/shotamomma/Documents/GitHub/shotam.github.io/Experiments/Octopus/Experiment2a/rmodels/N_OnsetThe_raw.rds")
N_OnsetThe_inverse <- readRDS(file = "/Users/shotamomma/Documents/GitHub/shotam.github.io/Experiments/Octopus/Experiment2a/rmodels/N_OnsetThe_inverse.rds")
...
N_AT_inverse <- glmer(ATRaw ~ Relatedness*VerbType + (1 + Relatedness*VerbType|participant) + (1+Relatedness|Verb), data = subset(df, df$DistractorType == "Noun"), family = inverse.gaussian(link = "identity"), control=glmerControl(optCtrl=list(maxfun=100000), optimizer = 'bobyqa'))


saveRDS(N_AT_log, file = "/Users/shotamomma/Documents/GitHub/shotam.github.io/Experiments/Octopus/Experiment2a/rmodels/N_AT_log.rds")
saveRDS(N_AT_raw, file = "/Users/shotamomma/Documents/GitHub/shotam.github.io/Experiments/Octopus/Experiment2a/rmodels/N_AT_raw.rds")
saveRDS(N_AT_inverse, file = "/Users/shotamomma/Documents/GitHub/shotam.github.io/Experiments/Octopus/Experiment2a/rmodels/N_AT_inverse.rds")

N_AT_log <- readRDS(file = "/Users/shotamomma/Documents/GitHub/shotam.github.io/Experiments/Octopus/Experiment2a/rmodels/N_AT_log.rds")
N_AT_raw <- readRDS(file = "/Users/shotamomma/Documents/GitHub/shotam.github.io/Experiments/Octopus/Experiment2a/rmodels/N_AT_raw.rds")
N_AT_inverse <- readRDS(file = "/Users/shotamomma/Documents/GitHub/shotam.github.io/Experiments/Octopus/Experiment2a/rmodels/N_AT_inverse.rds")
...
N_region_inverse <- glmer((ProductionTime) ~ Relatedness*VerbType*Region + (1 + Relatedness*Region|participant) + (1 + Relatedness*Region|Verb), data = dfNRaw, family = inverse.gaussian(link = "identity"), control=glmerControl(optCtrl=list(maxfun=100000), optimizer = 'bobyqa'))

saveRDS(N_region_log, file = "/Users/shotamomma/Documents/GitHub/shotam.github.io/Experiments/Octopus/Experiment2a/rmodels/N_region_log.rds")
saveRDS(N_region_raw, file = "/Users/shotamomma/Documents/GitHub/shotam.github.io/Experiments/Octopus/Experiment2a/rmodels/N_region_raw.rds")
saveRDS(N_region_inverse, file = "/Users/shotamomma/Documents/GitHub/shotam.github.io/Experiments/Octopus/Experiment2a/rmodels/N_region_inverse.rds")

N_region_log <- readRDS(file = "/Users/shotamomma/Documents/GitHub/shotam.github.io/Experiments/Octopus/Experiment2a/rmodels/N_region_log.rds")
N_region_raw <- readRDS(file = "/Users/shotamomma/Documents/GitHub/shotam.github.io/Experiments/Octopus/Experiment2a/rmodels/N_region_raw.rds")
N_region_inverse <- readRDS(file = "/Users/shotamomma/Documents/GitHub/shotam.github.io/Experiments/Octopus/Experiment2a/rmodels/N_region_inverse.rds")
