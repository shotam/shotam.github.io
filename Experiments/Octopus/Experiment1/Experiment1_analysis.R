...
df <- subset(df, df$experiment == "Exp1")
df$Picture<- interaction(df$Pic, df$Anoun)
df <- subset(df, df$participant != '15')

#df <- read.csv('/Users/shotamomma/Documents/GitHub/shotam.github.io/Experiments/Octopus/Experiment1/Experiment1.data.csv')
...
pdf('/Users/shotamomma/Documents/GitHub/shotam.github.io/Experiments/Octopus/Experiment1/distribution.pdf')
ggplot(subset(df, df$VerbType == "Unacc" & df$DistractorType == "Verb"), aes(OnsetThe, color=Relatedness)) +
...
pdf('/Users/shotamomma/Documents/GitHub/shotam.github.io/Experiments/Octopus/Experiment1/Vdifference.pdf')
...
pdf('/Users/shotamomma/Documents/GitHub/shotam.github.io/Experiments/Octopus/Experiment1/Ndifference.pdf')
ggplot(Graph, aes(x= region, y=mean, group=VerbType, color=VerbType)) +
  geom_line() +
  geom_point()+
  geom_errorbar(aes(ymin=mean-se, ymax=mean+se), width=.2,
...
pdf('/Users/shotamomma/Documents/GitHub/shotam.github.io/Experiments/Octopus/Experiment1/VOnset.pdf')
apa_lineplot(
  data = dfV_graph,
  id = "participant",
  dv = "OnsetThe",
...
pdf('/Users/shotamomma/Documents/GitHub/shotam.github.io/Experiments/Octopus/Experiment1/VAI.pdf')
apa_lineplot(
  dfV_graph,
  id = "participant",
  dv = "AI",
...
pdf('/Users/shotamomma/Documents/GitHub/shotam.github.io/Experiments/Octopus/Experiment1/NOnset.pdf')
apa_lineplot(
  dfN_graph,
  id = "participant",
  dv = "OnsetThe",
...
pdf('/Users/shotamomma/Documents/GitHub/shotam.github.io/Experiments/Octopus/Experiment1/NAT.pdf')
apa_lineplot(
  dfN_graph,
  id = "participant",
  dv = "AT",
...
dfV_OnsetThe$Relatedness <- scale(as.numeric(dfV_OnsetThe$Relatedness), scale = F)
dfV_OnsetThe$VerbType <- scale(as.numeric(dfV_OnsetThe$VerbType), scale = F)
...
drop1(V_OnsetThe_log, scope = c('Relatedness', 'VerbType', 'Relatedness:VerbType') ,test = 'Chisq')
...
drop1(V_OnsetThe_raw, scope = c('Relatedness', 'VerbType', 'Relatedness:VerbType') ,test = 'Chisq')
...
drop1(V_OnsetThe_inverse, scope = c('Relatedness', 'VerbType', 'Relatedness:VerbType') ,test = 'Chisq')


dfV_OnsetThe <- subset(dfV_OnsetThe, dfV_OnsetThe$ProductionTime > 0 & dfV_OnsetThe$Vcodability != 'NA')
dfV_OnsetThe$ProductionTimeResid <- residuals(V_resid)
V_OnsetThe_resid <- lmer((ProductionTimeResid) ~ Relatedness*VerbType + (1 + Relatedness*VerbType|participant) + (1+Relatedness|Verb/Anoun), data = dfV_OnsetThe, control=lmerControl(optCtrl=list(maxfun=100000)))

saveRDS(V_OnsetThe_log, file = "/Users/shotamomma/Documents/GitHub/shotam.github.io/Experiments/Octopus/Experiment1/rmodels/V_OnsetThe_log.rds")
saveRDS(V_OnsetThe_raw, file = "/Users/shotamomma/Documents/GitHub/shotam.github.io/Experiments/Octopus/Experiment1/rmodels/V_OnsetThe_raw.rds")
saveRDS(V_OnsetThe_inverse, file = "/Users/shotamomma/Documents/GitHub/shotam.github.io/Experiments/Octopus/Experiment1/rmodels/V_OnsetThe_inverse.rds")


#V_OnsetThe_raw <- readRDS("/Users/shotamomma/Documents/GitHub/shotam.github.io/Experiments/Octopus/Experiment1/rmodels/V_OnsetThe_raw.rds")
V_OnsetThe_log <- readRDS("/Users/shotamomma/Documents/GitHub/shotam.github.io/Experiments/Octopus/Experiment1/rmodels/V_OnsetThe_log.rds")
V_OnsetThe_inverse <- readRDS("/Users/shotamomma/Documents/GitHub/shotam.github.io/Experiments/Octopus/Experiment1/rmodels/V_OnsetThe_inverse.rds")

dfV_unacc <- subset(dfV, dfV$VerbType == "Unacc")
dfV_unacc$Relatedness <- scale(as.numeric(dfV_unacc$Relatedness), scale = F)
dfV_unacc$Region <- scale(as.numeric(dfV_unacc$Region), scale = F)
...
drop1(V_unacc_log, scope = c('Relatedness', 'Region', 'Relatedness:Region') ,test = 'Chisq')
...
drop1(V_unacc_raw, scope = c('Relatedness', 'Region', 'Relatedness:Region') ,test = 'Chisq')
...
saveRDS(V_unacc_log, file = "/Users/shotamomma/Documents/GitHub/shotam.github.io/Experiments/Octopus/Experiment1/rmodels/V_unacc_log.rds")
saveRDS(V_unacc_raw, file = "/Users/shotamomma/Documents/GitHub/shotam.github.io/Experiments/Octopus/Experiment1/rmodels/V_unacc_raw.rds")
saveRDS(V_unacc_inverse, file = "/Users/shotamomma/Documents/GitHub/shotam.github.io/Experiments/Octopus/Experiment1/rmodels/V_unacc_inverse.rds")
...
V_AI_inverse <- glmer((AIRaw) ~ Relatedness*VerbType + (1+VerbType|participant) + (1+Relatedness|Verb), data = subset(df, df$DistractorType == "Verb"), family = inverse.gaussian(link = "identity"), control=glmerControl(optCtrl=list(maxfun=100000), optimizer = 'bobyqa')) #### including by-subject random slope of Relatedness caused convergence failure


saveRDS(V_AI_log, file = "/Users/shotamomma/Documents/GitHub/shotam.github.io/Experiments/Octopus/Experiment1/rmodels/V_AI_log.rds")
saveRDS(V_AI_raw, file = "/Users/shotamomma/Documents/GitHub/shotam.github.io/Experiments/Octopus/Experiment1/rmodels/V_AI_raw.rds")
saveRDS(V_AI_inverse, file = "/Users/shotamomma/Documents/GitHub/shotam.github.io/Experiments/Octopus/Experiment1/rmodels/V_AI_inverse.rds")
...
N_OnsetThe_log <- lmer((ProductionTime) ~Relatedness*Vcodability + (1 + Relatedness*VerbType|participant) + (1 + Relatedness|Verb), data = dfN_OnsetThe, control=lmerControl(optCtrl=list(maxfun=100000)))
...
saveRDS(N_AT_log, file = "/Users/shotamomma/Documents/GitHub/shotam.github.io/Experiments/Octopus/Experiment1/rmodels/N_AT_log.rds")
saveRDS(N_AT_raw, file = "/Users/shotamomma/Documents/GitHub/shotam.github.io/Experiments/Octopus/Experiment1/rmodels/N_AT_raw.rds")
saveRDS(N_AT_inverse, file = "/Users/shotamomma/Documents/GitHub/shotam.github.io/Experiments/Octopus/Experiment1/rmodels/N_AT_inverse.rds")
...
N_region_inverse <- glmer((ProductionTime) ~ Relatedness*VerbType*Region + (1 + Relatedness*Region - Relatedness|participant) + (1 + Relatedness*Region|Verb), data = dfNRaw, family = inverse.gaussian(link = "identity"), control=glmerControl(optCtrl=list(maxfun=100000), optimizer = 'bobyqa'))

saveRDS(N_region_log, file = "/Users/shotamomma/Documents/GitHub/shotam.github.io/Experiments/Octopus/Experiment1/rmodels/N_region_log.rds")
saveRDS(N_region_raw, file = "/Users/shotamomma/Documents/GitHub/shotam.github.io/Experiments/Octopus/Experiment1/rmodels/N_region_raw.rds")
saveRDS(N_region_inverse, file = "/Users/shotamomma/Documents/GitHub/shotam.github.io/Experiments/Octopus/Experiment1/rmodels/N_region_inverse.rds")